...
export default function ContractPreview({ contractData, formData, dealId }) {
  ...
  const handleDownloadPDF = () => {
    ...
    // Generate the contract text with proper sections
